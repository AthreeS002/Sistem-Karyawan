...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(586, 452))
        ...
        self.label.setGeometry(QRect(110, 20, 351, 41))
        font = QFont()
        font.setPointSize(20)
        self.label.setFont(font)
        self.horizontalLayoutWidget = QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(100, 220, 371, 161))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(110, 120, 354, 80))
