...
################################################################################
## Form generated from reading UI file 'editpage_karyawan1.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(50, 69, 561, 51))
        ...
        self.label.setGeometry(QRect(190, 20, 281, 31))
        font1 = QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Input Karyawan ID to Edit", None))
    # retranslateUi
