...
################################################################################
## Form generated from reading UI file 'editpage_admin1.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QRect(240, 20, 241, 31))
        font = QFont()
        font.setPointSize(18)
        self.label.setFont(font)
        self.horizontalLayoutWidget = QWidget(Form)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(60, 69, 561, 51))
        ...
        self.btn_edit.setMaximumSize(QSize(50, 40))
        font1 = QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Input Admin ID to Edit", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"ID Admin:", None))
